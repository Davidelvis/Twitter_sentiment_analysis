"""
Contains classes which stream tweets from Twitter  to Kafka topics
"""
...
class TwitterClient(object):
    """
    Twitter client to download live tweets from twitter against a particular hashtag
    ...
    def tweet_callback(self, tweet):
        """
        This method is called when a tweet is received from Twitter and then it puts the tweet on Kafka topic
        Args:
            tweet (String): A tweet from twitter
        """
...
class TweetListener(tweepy.StreamListener):
    ...
    def on_status(self, status):
        """
        this method is called on receiving a new tweet
